...
//        }
//      )
//      .listen(socketProxyConfig.port())
//      .onItem().invoke(() -> log.info("socket 代理启功在端口 {}", socketProxyConfig.port()))
//      .onFailure().invoke(t -> {
...
//  }
//
//  public void init(@Observes StartupEvent e, Vertx vertx, SocketProxyVerticle verticle) {
